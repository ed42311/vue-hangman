...
<template>
  <div id="app">
    ...
    <svg width="350" height="260" viewBox="0 0 350 275"
      ...
      <circle v-if="strikes > 5"  cx="235" cy="85" r="3" stroke="black" stroke-width="1" fill="none" />
      <circle v-if="strikes > 5" cx="218" cy="85" r="3" stroke="black" stroke-width="1" fill="none" />
